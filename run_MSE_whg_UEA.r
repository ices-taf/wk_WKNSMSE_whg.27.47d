...
if (HCRoption %in% 1) {
  hcr_vals <- expand.grid(
    #Ftrgt =0.13,
    Ftrgt = seq(from = 0.14, to = 0.15, by = 0.01),
    Btrigger = seq(from = 230000, to = 230000, by = 10000))
  
} else if (HCRoption %in% 3) {
  hcr_vals <- expand.grid(
    #Ftrgt =0.13,
    Ftrgt = seq(from = 0.12, to = 0.14, by = 0.01),
    Btrigger = seq(from = 210000, to = 220000, by = 10000))
} else if (HCRoption %in% 4) {
  hcr_vals <- expand.grid(
    #Ftrgt =0.13,
    Ftrgt = seq(from = 0.12, to = 0.13, by = 0.01),
    Btrigger = seq(from = 210000, to = 220000, by = 10000))
} else if (HCRoption %in% 5) {
  hcr_vals <- expand.grid(
    #Ftrgt = 0.15,
    Ftrgt = seq(from = 0.15, to = 0.16, by = 0.01),
    Btrigger = seq(from = 210000, to = 220000, by = 10000))
  
} else if (HCRoption %in% 6) {
  hcr_vals <- expand.grid(
    #Ftrgt = 0.15,
    Ftrgt = seq(from = 0.16, to = 0.16, by = 0.01),
    Btrigger = seq(from = 240000, to = 240000, by = 10000))
